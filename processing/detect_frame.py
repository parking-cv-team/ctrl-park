...
def detect_frame_dual(
        frame,
        mcar_path: str = r'models_weights\best.pt', # path to the car detection model
        mped_path: str = r'models_weights\yolov5su.pt', # path to the pedestrian detection model
    ...
    return {
        ...
        'pedestrians': sv.Detections.from_ultralytics(detections_pedestrians)
    }
